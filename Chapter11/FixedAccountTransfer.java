...
public class SemaphoreExample {
    public static void main(String[] args) throws InterruptedException {
        // KEY CHOICE: Permits set to 2. At most 2 threads can bypass this bottleneck simultaneously.
        ...
        for (int i = 0; i < 5; i++) {
            Thread thread = new Thread(() -> {
                ...
                try {
                    // ACCURACY FIX: Sit outside the try-finally structure.
                    ...
                    // KEY CHOICE: This block only fires if acquire() completely succeeded.
