public class QuadraticProbingHashMap<K, V> {
    ...
    /**
     * Retrieves value for given key using quadratic probing
     */
    @SuppressWarnings("unchecked")
    public V get(K key) {
        int index = hash(key);
    ...
    /**
     * Removes key-value pair and returns the value using quadratic probing
     */
    @SuppressWarnings("unchecked")
